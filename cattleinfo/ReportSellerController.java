 ...
 * @author user
 */
public class ReportSellerController implements Initializable {
    ...
    @FXML
    private void SubmitOnClicked(ActionEvent event) throws IOException {
    ...
    @FXML
    private void BackToReportOnClicked(ActionEvent event) throws IOException {
