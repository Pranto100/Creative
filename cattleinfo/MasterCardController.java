 ...
 * @author user
 */
public class MasterCardController implements Initializable {
    ...
    @FXML
    private void ConfirmmedOnClicked(ActionEvent event) 
            throws IOException {
    ...
    @FXML
    private void BackingOnCLicked(ActionEvent event) 
            throws IOException {
